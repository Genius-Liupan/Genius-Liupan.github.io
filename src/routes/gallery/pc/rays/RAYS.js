...
const RAYS_DATA = {
  desc: (
    <React.Fragment>
      ...
      <p>
        具体了解可以通过RAYS体验网站：<a href="https://rays.5rs.me/index.html">https://rays.5rs.me</a>。不同的角色进入不同的后台，每个后台都有自身的代表色，作者-绿色，由于是内容生产者，需要长时间与文字打交道，绿色有知识的象征，同时有护眼的效果；编辑-红色，内容生产与维护，重点服务角色，也是赚钱与盈利的核心，因此用了有刺激消费与商业代表的红色；出版-蓝色，内容审核者，工作过程中更加需要的是眼严谨与稳重，因此蓝色最适宜。
      </p>
    </React.Fragment>
  ),
